...
CustomKeywords.'com.reusableComponent.HighlightElement.run'(findTestObject('Game/Page_Dashboard/span_MYR'))

WebUI.mouseOver(findTestObject('Game/Page_Dashboard/span_MYR'))

WebUI.click(findTestObject('Game/Page_Dashboard/span_MYR'))
