...
CustomKeywords.'com.reusableComponent.HighlightElement.run'(findTestObject('Game/Page_Dashboard/span_IDR'))

WebUI.mouseOver(findTestObject('Game/Page_Dashboard/span_IDR'))

WebUI.click(findTestObject('Game/Page_Dashboard/span_IDR'))
