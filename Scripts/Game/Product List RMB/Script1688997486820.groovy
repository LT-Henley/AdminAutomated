...
CustomKeywords.'com.reusableComponent.HighlightElement.run'(findTestObject('Game/Page_Dashboard/span_RMB'))

WebUI.mouseOver(findTestObject('Game/Page_Dashboard/span_RMB'))

WebUI.click(findTestObject('Game/Page_Dashboard/span_RMB'))
