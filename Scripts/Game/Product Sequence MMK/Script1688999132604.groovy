...
CustomKeywords.'com.reusableComponent.HighlightElement.run'(findTestObject('Game/Product Sequence/span_MMK'))

WebUI.mouseOver(findTestObject('Game/Product Sequence/span_MMK'))

WebUI.click(findTestObject('Game/Product Sequence/span_MMK'))
