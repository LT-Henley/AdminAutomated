...
CustomKeywords.'com.reusableComponent.HighlightElement.run'(findTestObject('Game/Page_Dashboard/span_THB'))

WebUI.mouseOver(findTestObject('Game/Page_Dashboard/span_THB'))

WebUI.click(findTestObject('Game/Page_Dashboard/span_THB'))
