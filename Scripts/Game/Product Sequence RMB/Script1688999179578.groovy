...
CustomKeywords.'com.reusableComponent.HighlightElement.run'(findTestObject('Game/Product Sequence/span_RMB'))

WebUI.mouseOver(findTestObject('Game/Product Sequence/span_RMB'))

WebUI.click(findTestObject('Game/Product Sequence/span_RMB'))
