...
CustomKeywords.'com.reusableComponent.HighlightElement.run'(findTestObject('Game/Product Sequence/span_IDR'))

WebUI.mouseOver(findTestObject('Game/Product Sequence/span_IDR'))

WebUI.click(findTestObject('Game/Product Sequence/span_IDR'))
