...
CustomKeywords.'com.reusableComponent.HighlightElement.run'(findTestObject('Game/Product Sequence/span_MYR'))

WebUI.mouseOver(findTestObject('Game/Product Sequence/span_MYR'))

WebUI.click(findTestObject('Game/Product Sequence/span_MYR'))
