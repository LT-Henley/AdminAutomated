...
CustomKeywords.'com.reusableComponent.HighlightElement.run'(findTestObject('VIP/Page_Dashboard/span_List MMK'))

WebUI.mouseOver(findTestObject('VIP/Page_Dashboard/span_List MMK'))

WebUI.click(findTestObject('VIP/Page_Dashboard/span_List MMK'))
