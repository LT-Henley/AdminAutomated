...
CustomKeywords.'com.reusableComponent.HighlightElement.run'(findTestObject('VIP/Page_Dashboard/span_IDR'))

WebUI.mouseOver(findTestObject('VIP/Page_Dashboard/span_IDR'))

CustomKeywords.'com.reusableComponent.HighlightElement.run'(findTestObject('VIP/Page_Dashboard/span_Sequence IDR'))

WebUI.mouseOver(findTestObject('VIP/Page_Dashboard/span_Sequence IDR'))

WebUI.click(findTestObject('VIP/Page_Dashboard/span_Sequence IDR'))
