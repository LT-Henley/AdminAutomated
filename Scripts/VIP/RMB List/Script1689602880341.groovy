...
CustomKeywords.'com.reusableComponent.HighlightElement.run'(findTestObject('VIP/Page_Dashboard/span_List RMB'))

WebUI.mouseOver(findTestObject('VIP/Page_Dashboard/span_List RMB'))

WebUI.click(findTestObject('VIP/Page_Dashboard/span_List RMB'))
