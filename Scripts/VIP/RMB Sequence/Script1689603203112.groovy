...
CustomKeywords.'com.reusableComponent.HighlightElement.run'(findTestObject('VIP/Page_Dashboard/span_RMB'))

WebUI.mouseOver(findTestObject('VIP/Page_Dashboard/span_RMB'))

CustomKeywords.'com.reusableComponent.HighlightElement.run'(findTestObject('VIP/Page_Dashboard/span_Sequence RMB'))

WebUI.mouseOver(findTestObject('VIP/Page_Dashboard/span_Sequence RMB'))

WebUI.click(findTestObject('VIP/Page_Dashboard/span_Sequence RMB'))
