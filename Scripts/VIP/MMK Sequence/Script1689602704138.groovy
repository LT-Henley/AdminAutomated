...
CustomKeywords.'com.reusableComponent.HighlightElement.run'(findTestObject('VIP/Page_Dashboard/span_MMK'))

WebUI.mouseOver(findTestObject('VIP/Page_Dashboard/span_MMK'))

CustomKeywords.'com.reusableComponent.HighlightElement.run'(findTestObject('VIP/Page_Dashboard/span_Sequence MMK'))

WebUI.mouseOver(findTestObject('VIP/Page_Dashboard/span_Sequence MMK'))

WebUI.click(findTestObject('VIP/Page_Dashboard/span_Sequence MMK'))
