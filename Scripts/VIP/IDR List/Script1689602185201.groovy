...
CustomKeywords.'com.reusableComponent.HighlightElement.run'(findTestObject('VIP/Page_Dashboard/span_List IDR'))

WebUI.mouseOver(findTestObject('VIP/Page_Dashboard/span_List IDR'))

WebUI.click(findTestObject('VIP/Page_Dashboard/span_List IDR'))
