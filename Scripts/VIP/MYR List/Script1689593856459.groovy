...
CustomKeywords.'com.reusableComponent.HighlightElement.run'(findTestObject('VIP/Vip List/span_List'))

WebUI.mouseOver(findTestObject('VIP/Vip List/span_List'))

WebUI.click(findTestObject('VIP/Vip List/span_List'))
