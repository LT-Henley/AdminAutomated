...
CustomKeywords.'com.reusableComponent.HighlightElement.run'(findTestObject('Interest/Page_Dashboard/span_Interest List MMK'))

WebUI.mouseOver(findTestObject('Interest/Page_Dashboard/span_Interest List MMK'))

WebUI.click(findTestObject('Interest/Page_Dashboard/span_Interest List MMK'))
