...
CustomKeywords.'com.reusableComponent.HighlightElement.run'(findTestObject('Interest/Page_Dashboard/span_Interest List THB'))

WebUI.mouseOver(findTestObject('Interest/Page_Dashboard/span_Interest List THB'))

WebUI.click(findTestObject('Interest/Page_Dashboard/span_Interest List THB'))
