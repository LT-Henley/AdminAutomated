...
CustomKeywords.'com.reusableComponent.HighlightElement.run'(findTestObject('Interest/Page_Dashboard/span_Interest List MYR'))

WebUI.mouseOver(findTestObject('Interest/Page_Dashboard/span_Interest List MYR'))

WebUI.click(findTestObject('Interest/Page_Dashboard/span_Interest List MYR'))
