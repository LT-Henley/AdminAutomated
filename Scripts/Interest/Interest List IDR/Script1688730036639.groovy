...
CustomKeywords.'com.reusableComponent.HighlightElement.run'(findTestObject('Interest/Page_Dashboard/span_Interest List IDR'))

WebUI.mouseOver(findTestObject('Interest/Page_Dashboard/span_Interest List IDR'))

WebUI.click(findTestObject('Interest/Page_Dashboard/span_Interest List IDR'))
