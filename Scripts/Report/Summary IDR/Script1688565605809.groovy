...
CustomKeywords.'com.reusableComponent.HighlightElement.run'(findTestObject('Report/Page_Dashboard/span_Summary IDR'))

WebUI.mouseOver(findTestObject('Report/Page_Dashboard/span_Summary IDR'))

WebUI.click(findTestObject('Report/Page_Dashboard/span_Summary IDR'))
