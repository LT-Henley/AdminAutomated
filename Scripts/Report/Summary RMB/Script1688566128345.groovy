...
CustomKeywords.'com.reusableComponent.HighlightElement.run'(findTestObject('Report/Page_Dashboard/span_Summary RMB'))

WebUI.mouseOver(findTestObject('Report/Page_Dashboard/span_Summary RMB'))

WebUI.click(findTestObject('Report/Page_Dashboard/span_Summary RMB'))
