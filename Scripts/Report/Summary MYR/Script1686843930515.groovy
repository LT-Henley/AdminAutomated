...
CustomKeywords.'com.reusableComponent.HighlightElement.run'(findTestObject('Report/Page_Dashboard/span_Summary MYR'))

WebUI.mouseOver(findTestObject('Report/Page_Dashboard/span_Summary MYR'))

WebUI.click(findTestObject('Report/Page_Dashboard/span_Summary MYR'))
