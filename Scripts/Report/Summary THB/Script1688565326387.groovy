...
CustomKeywords.'com.reusableComponent.HighlightElement.run'(findTestObject('Report/Page_Dashboard/span_Summary THB'))

WebUI.mouseOver(findTestObject('Report/Page_Dashboard/span_Summary THB'))

WebUI.click(findTestObject('Report/Page_Dashboard/span_Summary THB'))
