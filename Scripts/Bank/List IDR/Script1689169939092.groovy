...
CustomKeywords.'com.reusableComponent.HighlightElement.run'(findTestObject('Bank/Bank List/span_IDR'))

WebUI.mouseOver(findTestObject('Bank/Bank List/span_IDR'))

WebUI.click(findTestObject('Bank/Bank List/span_IDR'))
