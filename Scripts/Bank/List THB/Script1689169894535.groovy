...
CustomKeywords.'com.reusableComponent.HighlightElement.run'(findTestObject('Bank/Bank List/span_THB'))

WebUI.mouseOver(findTestObject('Bank/Bank List/span_THB'))

WebUI.click(findTestObject('Bank/Bank List/span_THB'))
