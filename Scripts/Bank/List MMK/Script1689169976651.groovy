...
CustomKeywords.'com.reusableComponent.HighlightElement.run'(findTestObject('Bank/Bank List/span_MMK'))

WebUI.mouseOver(findTestObject('Bank/Bank List/span_MMK'))

WebUI.click(findTestObject('Bank/Bank List/span_MMK'))
