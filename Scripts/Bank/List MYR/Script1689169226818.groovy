...
CustomKeywords.'com.reusableComponent.HighlightElement.run'(findTestObject('Bank/Bank List/span_MYR'))

WebUI.mouseOver(findTestObject('Bank/Bank List/span_MYR'))

WebUI.click(findTestObject('Bank/Bank List/span_MYR'))
