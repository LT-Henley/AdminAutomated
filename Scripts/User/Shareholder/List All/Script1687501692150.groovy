...
CustomKeywords.'com.reusableComponent.HighlightElement.run'(findTestObject('User/Shareholder/User List/span_All'))

WebUI.mouseOver(findTestObject('User/Shareholder/User List/span_All'))

WebUI.click(findTestObject('User/Shareholder/User List/span_All'))
