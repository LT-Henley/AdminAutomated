...
CustomKeywords.'com.reusableComponent.HighlightElement.run'(findTestObject('User/Shareholder/span_List'))

WebUI.mouseOver(findTestObject('User/Shareholder/span_List'))

CustomKeywords.'com.reusableComponent.HighlightElement.run'(findTestObject('User/Shareholder/User List/span_MYR'))

WebUI.mouseOver(findTestObject('User/Shareholder/User List/span_MYR'))

WebUI.click(findTestObject('User/Shareholder/User List/span_MYR'))
