...
CustomKeywords.'com.reusableComponent.HighlightElement.run'(findTestObject('User/Shareholder/User Wallets/span_MMK'))

WebUI.mouseOver(findTestObject('User/Shareholder/User Wallets/span_MMK'))

WebUI.click(findTestObject('User/Shareholder/User Wallets/span_MMK'))
