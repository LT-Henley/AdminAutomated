...
CustomKeywords.'com.reusableComponent.HighlightElement.run'(findTestObject('User/Shareholder/Positive Wallet/span_THB'))

WebUI.mouseOver(findTestObject('User/Shareholder/Positive Wallet/span_THB'))

WebUI.click(findTestObject('User/Shareholder/Positive Wallet/span_THB'))
