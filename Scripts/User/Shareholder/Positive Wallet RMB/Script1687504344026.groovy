...
CustomKeywords.'com.reusableComponent.HighlightElement.run'(findTestObject('User/Shareholder/Positive Wallet/span_RMB'))

WebUI.mouseOver(findTestObject('User/Shareholder/Positive Wallet/span_RMB'))

WebUI.click(findTestObject('User/Shareholder/Positive Wallet/span_RMB'))
