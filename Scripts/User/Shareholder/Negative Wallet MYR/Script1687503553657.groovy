...
CustomKeywords.'com.reusableComponent.HighlightElement.run'(findTestObject('User/Shareholder/Negative Wallet/span_MYR'))

WebUI.mouseOver(findTestObject('User/Shareholder/Negative Wallet/span_MYR'))

WebUI.click(findTestObject('User/Shareholder/Negative Wallet/span_MYR'))
