...
CustomKeywords.'com.reusableComponent.HighlightElement.run'(findTestObject('User/Shareholder/Positive Wallet/span_USD'))

WebUI.mouseOver(findTestObject('User/Shareholder/Positive Wallet/span_USD'))

WebUI.click(findTestObject('User/Shareholder/Positive Wallet/span_USD'))
