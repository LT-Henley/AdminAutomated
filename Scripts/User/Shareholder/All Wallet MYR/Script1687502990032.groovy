...
CustomKeywords.'com.reusableComponent.HighlightElement.run'(findTestObject('User/Shareholder/User Wallets/span_MYR'))

WebUI.mouseOver(findTestObject('User/Shareholder/User Wallets/span_MYR'))

WebUI.click(findTestObject('User/Shareholder/User Wallets/span_MYR'))
