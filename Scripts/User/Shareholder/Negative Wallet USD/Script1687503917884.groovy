...
CustomKeywords.'com.reusableComponent.HighlightElement.run'(findTestObject('User/Shareholder/Negative Wallet/span_USD'))

WebUI.mouseOver(findTestObject('User/Shareholder/Negative Wallet/span_USD'))

WebUI.click(findTestObject('User/Shareholder/Negative Wallet/span_USD'))
