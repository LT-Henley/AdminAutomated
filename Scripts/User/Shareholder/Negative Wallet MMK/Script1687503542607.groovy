...
CustomKeywords.'com.reusableComponent.HighlightElement.run'(findTestObject('User/Shareholder/Negative Wallet/span_MMK'))

WebUI.mouseOver(findTestObject('User/Shareholder/Negative Wallet/span_MMK'))

WebUI.click(findTestObject('User/Shareholder/Negative Wallet/span_MMK'))
