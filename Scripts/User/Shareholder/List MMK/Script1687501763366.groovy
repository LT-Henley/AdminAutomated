...
CustomKeywords.'com.reusableComponent.HighlightElement.run'(findTestObject('User/Shareholder/User List/span_MMK'))

WebUI.mouseOver(findTestObject('User/Shareholder/User List/span_MMK'))

WebUI.click(findTestObject('User/Shareholder/User List/span_MMK'))
