...
CustomKeywords.'com.reusableComponent.HighlightElement.run'(findTestObject('User/Shareholder/span_Duplicate IP Logins'))

WebUI.mouseOver(findTestObject('User/Shareholder/span_Duplicate IP Logins'))

WebUI.click(findTestObject('User/Shareholder/span_Duplicate IP Logins'))

CustomKeywords.'com.reusableComponent.HighlightElement.run'(findTestObject('User/Shareholder/User List/h3_Shareholder Duplicate IP Logins'))
...
WebUI.verifyElementVisible(findTestObject('User/Shareholder/User List/h3_Shareholder Duplicate IP Logins'))
...
CustomKeywords.'com.reusableComponent.HighlightElement.run'(findTestObject('User/Shareholder/User List/th_Username'))
...
WebUI.verifyElementVisible(findTestObject('User/Shareholder/User List/th_Username'))
