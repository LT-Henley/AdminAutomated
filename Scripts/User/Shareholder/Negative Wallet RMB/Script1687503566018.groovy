...
CustomKeywords.'com.reusableComponent.HighlightElement.run'(findTestObject('User/Shareholder/Negative Wallet/span_RMB'))

WebUI.mouseOver(findTestObject('User/Shareholder/Negative Wallet/span_RMB'))

WebUI.click(findTestObject('User/Shareholder/Negative Wallet/span_RMB'))
