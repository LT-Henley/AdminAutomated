...
CustomKeywords.'com.reusableComponent.HighlightElement.run'(findTestObject('User/Shareholder/Positive Wallet/span_IDR'))

WebUI.mouseOver(findTestObject('User/Shareholder/Positive Wallet/span_IDR'))

WebUI.click(findTestObject('User/Shareholder/Positive Wallet/span_IDR'))
