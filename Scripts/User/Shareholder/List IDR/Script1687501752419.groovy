...
CustomKeywords.'com.reusableComponent.HighlightElement.run'(findTestObject('User/Shareholder/User List/span_IDR'))

WebUI.mouseOver(findTestObject('User/Shareholder/User List/span_IDR'))

WebUI.click(findTestObject('User/Shareholder/User List/span_IDR'))
