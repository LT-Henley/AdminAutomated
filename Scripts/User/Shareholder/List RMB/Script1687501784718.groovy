...
CustomKeywords.'com.reusableComponent.HighlightElement.run'(findTestObject('User/Shareholder/User List/span_RMB'))

WebUI.mouseOver(findTestObject('User/Shareholder/User List/span_RMB'))

WebUI.click(findTestObject('User/Shareholder/User List/span_RMB'))
