...
CustomKeywords.'com.reusableComponent.HighlightElement.run'(findTestObject('User/Shareholder/User Wallets/span_RMB'))

WebUI.mouseOver(findTestObject('User/Shareholder/User Wallets/span_RMB'))

WebUI.click(findTestObject('User/Shareholder/User Wallets/span_RMB'))
