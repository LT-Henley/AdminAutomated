...
CustomKeywords.'com.reusableComponent.HighlightElement.run'(findTestObject('User/Shareholder/Positive Wallet/span_MMK'))

WebUI.mouseOver(findTestObject('User/Shareholder/Positive Wallet/span_MMK'))

WebUI.click(findTestObject('User/Shareholder/Positive Wallet/span_MMK'))
