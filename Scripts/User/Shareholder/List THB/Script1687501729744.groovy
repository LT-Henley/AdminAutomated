...
CustomKeywords.'com.reusableComponent.HighlightElement.run'(findTestObject('User/Shareholder/User List/span_THB'))

WebUI.mouseOver(findTestObject('User/Shareholder/User List/span_THB'))

WebUI.click(findTestObject('User/Shareholder/User List/span_THB'))
