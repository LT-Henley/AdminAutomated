...
CustomKeywords.'com.reusableComponent.HighlightElement.run'(findTestObject('User/Member/Page_Dashboard/span_RMB'))

WebUI.mouseOver(findTestObject('User/Member/Page_Dashboard/span_RMB'))

WebUI.click(findTestObject('User/Member/Page_Dashboard/span_RMB'))
