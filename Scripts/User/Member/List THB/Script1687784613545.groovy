...
CustomKeywords.'com.reusableComponent.HighlightElement.run'(findTestObject('User/Member/Page_Dashboard/span_THB'))

WebUI.mouseOver(findTestObject('User/Member/Page_Dashboard/span_THB'))

WebUI.click(findTestObject('User/Member/Page_Dashboard/span_THB'))
