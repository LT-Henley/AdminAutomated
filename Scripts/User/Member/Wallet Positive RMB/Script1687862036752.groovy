...
CustomKeywords.'com.reusableComponent.HighlightElement.run'(findTestObject('User/Member/Wallet Positive/span_RMB'))

WebUI.click(findTestObject('User/Member/Wallet Positive/span_RMB'))
