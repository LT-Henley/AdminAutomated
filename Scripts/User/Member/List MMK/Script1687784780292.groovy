...
CustomKeywords.'com.reusableComponent.HighlightElement.run'(findTestObject('User/Member/Page_Dashboard/span_MMK'))

WebUI.mouseOver(findTestObject('User/Member/Page_Dashboard/span_MMK'))

WebUI.click(findTestObject('User/Member/Page_Dashboard/span_MMK'))
