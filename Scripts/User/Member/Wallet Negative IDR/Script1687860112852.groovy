...
CustomKeywords.'com.reusableComponent.HighlightElement.run'(findTestObject('User/Member/Wallet Negative/span_IDR'))

WebUI.mouseOver(findTestObject('User/Member/Wallet Negative/span_IDR'))

WebUI.click(findTestObject('User/Member/Wallet Negative/span_IDR'))
