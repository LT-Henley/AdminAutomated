...
CustomKeywords.'com.reusableComponent.HighlightElement.run'(findTestObject('User/Member/Wallet Negative/span_THB'))

WebUI.mouseOver(findTestObject('User/Member/Wallet Negative/span_THB'))

WebUI.click(findTestObject('User/Member/Wallet Negative/span_THB'))
