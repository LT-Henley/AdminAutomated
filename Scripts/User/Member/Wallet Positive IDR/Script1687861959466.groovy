...
CustomKeywords.'com.reusableComponent.HighlightElement.run'(findTestObject('User/Member/Wallet Positive/span_IDR'))

WebUI.click(findTestObject('User/Member/Wallet Positive/span_IDR'))
