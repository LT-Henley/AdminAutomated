...
CustomKeywords.'com.reusableComponent.HighlightElement.run'(findTestObject('User/Member/Wallet Negative/span_RMB'))

WebUI.mouseOver(findTestObject('User/Member/Wallet Negative/span_RMB'))

WebUI.click(findTestObject('User/Member/Wallet Negative/span_RMB'))
