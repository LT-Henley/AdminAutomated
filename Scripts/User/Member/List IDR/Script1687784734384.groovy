...
CustomKeywords.'com.reusableComponent.HighlightElement.run'(findTestObject('User/Member/Page_Dashboard/span_IDR'))

WebUI.mouseOver(findTestObject('User/Member/Page_Dashboard/span_IDR'))

WebUI.click(findTestObject('User/Member/Page_Dashboard/span_IDR'))
