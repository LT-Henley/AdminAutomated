...
CustomKeywords.'com.reusableComponent.HighlightElement.run'(findTestObject('User/Member/Wallet Negative/span_MMK'))

WebUI.mouseOver(findTestObject('User/Member/Wallet Negative/span_MMK'))

WebUI.click(findTestObject('User/Member/Wallet Negative/span_MMK'))
