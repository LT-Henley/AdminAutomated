...
CustomKeywords.'com.reusableComponent.HighlightElement.run'(findTestObject('Leaderboard/Leaderboard Ranking/span_IDR'))

WebUI.mouseOver(findTestObject('Leaderboard/Leaderboard Ranking/span_IDR'))

WebUI.click(findTestObject('Leaderboard/Leaderboard Ranking/span_IDR'))
