...
CustomKeywords.'com.reusableComponent.HighlightElement.run'(findTestObject('Leaderboard/Leaderboard Ranking/span_MYR'))

WebUI.mouseOver(findTestObject('Leaderboard/Leaderboard Ranking/span_MYR'))

WebUI.click(findTestObject('Leaderboard/Leaderboard Ranking/span_MYR'))
