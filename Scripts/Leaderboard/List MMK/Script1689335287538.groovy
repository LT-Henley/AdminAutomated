...
CustomKeywords.'com.reusableComponent.HighlightElement.run'(findTestObject('Leaderboard/Page_Dashboard/span_MMK'))

WebUI.mouseOver(findTestObject('Leaderboard/Page_Dashboard/span_MMK'))

WebUI.click(findTestObject('Leaderboard/Page_Dashboard/span_MMK'))
