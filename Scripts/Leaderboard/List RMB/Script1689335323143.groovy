...
CustomKeywords.'com.reusableComponent.HighlightElement.run'(findTestObject('Leaderboard/Page_Dashboard/span_RMB'))

WebUI.mouseOver(findTestObject('Leaderboard/Page_Dashboard/span_RMB'))

WebUI.click(findTestObject('Leaderboard/Page_Dashboard/span_RMB'))
