...
CustomKeywords.'com.reusableComponent.HighlightElement.run'(findTestObject('Leaderboard/Leaderboard Ranking/span_RMB'))

WebUI.mouseOver(findTestObject('Leaderboard/Leaderboard Ranking/span_RMB'))

WebUI.click(findTestObject('Leaderboard/Leaderboard Ranking/span_RMB'))
