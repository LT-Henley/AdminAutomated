...
CustomKeywords.'com.reusableComponent.HighlightElement.run'(findTestObject('Leaderboard/Leaderboard Ranking/span_THB'))

WebUI.mouseOver(findTestObject('Leaderboard/Leaderboard Ranking/span_THB'))

WebUI.click(findTestObject('Leaderboard/Leaderboard Ranking/span_THB'))
