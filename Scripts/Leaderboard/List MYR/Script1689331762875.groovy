...
CustomKeywords.'com.reusableComponent.HighlightElement.run'(findTestObject('Leaderboard/Page_Dashboard/span_MYR'))

WebUI.mouseOver(findTestObject('Leaderboard/Page_Dashboard/span_MYR'))

WebUI.click(findTestObject('Leaderboard/Page_Dashboard/span_MYR'))
