...
CustomKeywords.'com.reusableComponent.HighlightElement.run'(findTestObject('Leaderboard/Page_Dashboard/span_IDR'))

WebUI.mouseOver(findTestObject('Leaderboard/Page_Dashboard/span_IDR'))

WebUI.click(findTestObject('Leaderboard/Page_Dashboard/span_IDR'))
