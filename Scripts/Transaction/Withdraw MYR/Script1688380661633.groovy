...
WebUI.mouseOver(findTestObject('Transaction/Withdraw/span_MYR'))

CustomKeywords.'com.reusableComponent.HighlightElement.run'(findTestObject('Transaction/Withdraw/span_MYR'))

WebUI.click(findTestObject('Transaction/Withdraw/span_MYR'))
