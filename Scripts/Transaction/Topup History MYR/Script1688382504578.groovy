...
WebUI.mouseOver(findTestObject('Transaction/Topup History/span_MYR'))

CustomKeywords.'com.reusableComponent.HighlightElement.run'(findTestObject('Transaction/Topup History/span_MYR'))

WebUI.click(findTestObject('Transaction/Topup History/span_MYR'))
