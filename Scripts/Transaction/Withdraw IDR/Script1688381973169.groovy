...
WebUI.mouseOver(findTestObject('Transaction/Withdraw/span_IDR'))

CustomKeywords.'com.reusableComponent.HighlightElement.run'(findTestObject('Transaction/Withdraw/span_IDR'))

WebUI.click(findTestObject('Transaction/Withdraw/span_IDR'))
