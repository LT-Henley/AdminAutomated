...
CustomKeywords.'com.reusableComponent.HighlightElement.run'(findTestObject('Transaction/Withdraw history/span_MMK'))

WebUI.click(findTestObject('Transaction/Withdraw history/span_MMK'))
