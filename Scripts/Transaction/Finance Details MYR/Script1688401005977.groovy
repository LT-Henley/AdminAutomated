...
CustomKeywords.'com.reusableComponent.HighlightElement.run'(findTestObject('Transaction/Finance Details/span_MYR'))

WebUI.mouseOver(findTestObject('Transaction/Finance Details/span_MYR'))

WebUI.click(findTestObject('Transaction/Finance Details/span_MYR'))
