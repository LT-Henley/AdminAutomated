...
WebUI.mouseOver(findTestObject('Transaction/Topup History/span_RMB'))

CustomKeywords.'com.reusableComponent.HighlightElement.run'(findTestObject('Transaction/Topup History/span_RMB'))

WebUI.click(findTestObject('Transaction/Topup History/span_RMB'))
