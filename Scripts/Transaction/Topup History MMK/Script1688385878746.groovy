...
WebUI.mouseOver(findTestObject('Transaction/Topup History/span_MMK'))

CustomKeywords.'com.reusableComponent.HighlightElement.run'(findTestObject('Transaction/Topup History/span_MMK'))

WebUI.click(findTestObject('Transaction/Topup History/span_MMK'))
