...
CustomKeywords.'com.reusableComponent.HighlightElement.run'(findTestObject('Transaction/Finance Details/span_MMK'))

WebUI.mouseOver(findTestObject('Transaction/Finance Details/span_MMK'))

WebUI.click(findTestObject('Transaction/Finance Details/span_MMK'))
