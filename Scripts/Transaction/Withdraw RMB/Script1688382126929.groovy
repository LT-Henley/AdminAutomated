...
WebUI.mouseOver(findTestObject('Transaction/Withdraw/span_RMB'))

CustomKeywords.'com.reusableComponent.HighlightElement.run'(findTestObject('Transaction/Withdraw/span_RMB'))

WebUI.click(findTestObject('Transaction/Withdraw/span_RMB'))
