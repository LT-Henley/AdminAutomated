...
WebUI.mouseOver(findTestObject('Transaction/Topup History/span_THB'))

CustomKeywords.'com.reusableComponent.HighlightElement.run'(findTestObject('Transaction/Topup History/span_THB'))

WebUI.click(findTestObject('Transaction/Topup History/span_THB'))
