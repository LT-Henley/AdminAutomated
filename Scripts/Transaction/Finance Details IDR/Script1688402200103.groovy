...
CustomKeywords.'com.reusableComponent.HighlightElement.run'(findTestObject('Transaction/Finance Details/span_IDR'))

WebUI.mouseOver(findTestObject('Transaction/Finance Details/span_IDR'))

WebUI.click(findTestObject('Transaction/Finance Details/span_IDR'))
