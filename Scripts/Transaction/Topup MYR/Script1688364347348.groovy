...
CustomKeywords.'com.reusableComponent.HighlightElement.run'(findTestObject('Transaction/Top Up/span_MYR'))

WebUI.click(findTestObject('Transaction/Top Up/span_MYR'))
