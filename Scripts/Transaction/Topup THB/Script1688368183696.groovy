...
CustomKeywords.'com.reusableComponent.HighlightElement.run'(findTestObject('Transaction/Top Up/span_THB'))

WebUI.click(findTestObject('Transaction/Top Up/span_THB'))
