...
CustomKeywords.'com.reusableComponent.HighlightElement.run'(findTestObject('Transaction/Finance Details/span_THB'))

WebUI.mouseOver(findTestObject('Transaction/Finance Details/span_THB'))

WebUI.click(findTestObject('Transaction/Finance Details/span_THB'))
