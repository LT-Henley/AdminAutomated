...
CustomKeywords.'com.reusableComponent.HighlightElement.run'(findTestObject('Transaction/Withdraw history/span_IDR'))

WebUI.click(findTestObject('Transaction/Withdraw history/span_IDR'))
