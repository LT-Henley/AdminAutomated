...
CustomKeywords.'com.reusableComponent.HighlightElement.run'(findTestObject('Transaction/Withdraw history/span_RMB'))

WebUI.click(findTestObject('Transaction/Withdraw history/span_RMB'))
