...
WebUI.mouseOver(findTestObject('Transaction/Topup History/span_USD'))

CustomKeywords.'com.reusableComponent.HighlightElement.run'(findTestObject('Transaction/Topup History/span_USD'))

WebUI.click(findTestObject('Transaction/Topup History/span_USD'))
