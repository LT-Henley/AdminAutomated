...
WebUI.mouseOver(findTestObject('Transaction/Withdraw/span_MMK'))

CustomKeywords.'com.reusableComponent.HighlightElement.run'(findTestObject('Transaction/Withdraw/span_MMK'))

WebUI.click(findTestObject('Transaction/Withdraw/span_MMK'))
