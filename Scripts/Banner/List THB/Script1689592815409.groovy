...
CustomKeywords.'com.reusableComponent.HighlightElement.run'(findTestObject('Banner/Banner List/span_THB'))

WebUI.mouseOver(findTestObject('Banner/Banner List/span_THB'))

WebUI.click(findTestObject('Banner/Banner List/span_THB'))
