...
CustomKeywords.'com.reusableComponent.HighlightElement.run'(findTestObject('Banner/Banner Sequence/span_All'))

WebUI.mouseOver(findTestObject('Banner/Banner Sequence/span_All'))

WebUI.click(findTestObject('Banner/Banner Sequence/span_All'))
