...
CustomKeywords.'com.reusableComponent.HighlightElement.run'(findTestObject('Banner/Banner List/span_MMK'))

WebUI.mouseOver(findTestObject('Banner/Banner List/span_MMK'))

WebUI.click(findTestObject('Banner/Banner List/span_MMK'))
