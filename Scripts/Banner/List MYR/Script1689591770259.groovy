...
CustomKeywords.'com.reusableComponent.HighlightElement.run'(findTestObject('Banner/Banner List/span_MYR'))

WebUI.mouseOver(findTestObject('Banner/Banner List/span_MYR'))

WebUI.click(findTestObject('Banner/Banner List/span_MYR'))
