...
CustomKeywords.'com.reusableComponent.HighlightElement.run'(findTestObject('Banner/Banner List/span_RMB'))

WebUI.mouseOver(findTestObject('Banner/Banner List/span_RMB'))

WebUI.click(findTestObject('Banner/Banner List/span_RMB'))
