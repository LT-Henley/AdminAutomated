...
CustomKeywords.'com.reusableComponent.HighlightElement.run'(findTestObject('Banner/Banner Sequence/span_THB'))

WebUI.mouseOver(findTestObject('Banner/Banner Sequence/span_THB'))

WebUI.click(findTestObject('Banner/Banner Sequence/span_THB'))
