...
CustomKeywords.'com.reusableComponent.HighlightElement.run'(findTestObject('Banner/Banner List/span_IDR'))

WebUI.mouseOver(findTestObject('Banner/Banner List/span_IDR'))

WebUI.click(findTestObject('Banner/Banner List/span_IDR'))
